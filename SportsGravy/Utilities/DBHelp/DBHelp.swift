...
class DBHelper
{
    ...
    func insert(Id: Int,postuser_id: String,postuser_firstName:String,postuser_lastName: String,postuser_middleInitial: String,postuser_suffix: String,postuser_role: String,postuser_avatar:String,postuser_feedText: String,postuser_feedImageURL: String,postuser_feedVideoURL:String,postuser_Level:String,postuserOrg_id:String,postuser_Org_name:String,postuser_Org_abbre:String,postuser_tag_id: String,postuser_tag_name: String,postuser_Title:String,cannedResponseDesc: String,reaction:String,feedOrg_id: String, level_id: String, level_name: String,membergroup_id: String, membergroup_name: String, organization_id: String, organization_name: String,season_id: String, season_name: String,sport_id: String, sport_name: String,team_id: String,team_name: String,user_id: String,user_name: String)
    {
        let persons = read()
        for p in persons
        {
        ...
        if sqlite3_prepare_v2(db, insertStatementString, -1, &insertStatement, nil) == SQLITE_OK {
            ...
            sqlite3_bind_text(insertStatement, 16, (postuser_tag_name as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 17, (postuser_Title as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 18, (cannedResponseDesc as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 19, (reaction as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 20, (feedOrg_id as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 21, (level_id as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 22, (level_name as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 23, (membergroup_id as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 24, (membergroup_name as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 25, (organization_id as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 26, (organization_name as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 27, (season_id as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 28, (season_name as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 29, (sport_id as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 30, (sport_name as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 31, (team_id as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 32, (team_name as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 33, (user_id as NSString).utf8String, -1, nil)
            sqlite3_bind_text(insertStatement, 34, (user_name as NSString).utf8String, -1, nil)
    ...
    func read() -> [FeedPostData] {
        ...
        if sqlite3_prepare_v2(db, queryStatementString, -1, &queryStatement, nil) == SQLITE_OK {
            while sqlite3_step(queryStatement) == SQLITE_ROW {
                ...
                let postuser_tag_name = String(describing: String(cString:sqlite3_column_text(queryStatement, 16)))
                let postuser_Title = String(describing: String(cString: sqlite3_column_text(queryStatement, 17)))
                let cannedResponseDesc = String(describing: String(cString: sqlite3_column_text(queryStatement, 18)))
                let reaction = String(describing: String(cString: sqlite3_column_text(queryStatement, 19)))
                let feedOrg_id = String(describing: String(cString: sqlite3_column_text(queryStatement, 20)))
                let level_id = String(describing: String(cString: sqlite3_column_text(queryStatement, 21)))
                let level_name = String(describing: String(cString: sqlite3_column_text(queryStatement,22)))
                let membergroup_id = String(describing: String(cString: sqlite3_column_text(queryStatement, 23)))
                let membergroup_name = String(describing: String(cString: sqlite3_column_text(queryStatement, 24)))
                let organization_id = String(describing: String(cString: sqlite3_column_text(queryStatement, 25)))
                let organization_name = String(describing: String(cString: sqlite3_column_text(queryStatement, 26)))
                let season_id = String(describing: String(cString: sqlite3_column_text(queryStatement, 27)))
                let season_name = String(describing: String(cString: sqlite3_column_text(queryStatement, 28)))
                let sport_id = String(describing: String(cString: sqlite3_column_text(queryStatement, 29)))
                let sport_name = String(describing: String(cString: sqlite3_column_text(queryStatement, 30)))
                let team_id = String(describing: String(cString: sqlite3_column_text(queryStatement, 31)))
                let team_name = String(describing: String(cString: sqlite3_column_text(queryStatement, 32)))
                let user_id = String(describing: String(cString: sqlite3_column_text(queryStatement, 33)))
                let user_name = String(describing: String(cString: sqlite3_column_text(queryStatement, 34)))
                psns.append(FeedPostData(id: Int(id), feedPostedUser_id: postuser_id, feedPostedUser_firstName: postuser_firstName, feedPostedUser_lastName: postuser_lastName, feedPostedUser_middleInitial: postuser_middleInitial, feedPostedUser_suffix: postuser_suffix, feedPostedUser_role: postuser_role, feedPostedUser_avatar: postuser_avatar, feedText: postuser_feedText, feedImageURL: postuser_feedImageURL, feedVideoURL: postuser_feedVideoURL, lastSelectedFeededLevel: postuser_Level, feedPostedOrg_id: postuserOrg_id, feedPostedOrg_name: postuser_Org_name, feedPostedOrg_abbre: postuser_Org_abbre, tag_id: postuser_tag_id,tag_name: postuser_tag_name,  cannedResponseTitle: postuser_Title, cannedResponseDesc: cannedResponseDesc, reaction: reaction, feedOrg_id: feedOrg_id, level_id: level_id, level_name: level_name, membergroup_id: membergroup_id, membergroup_name: membergroup_name, organization_id: organization_id, organization_name: organization_name, season_id: season_id, season_label: season_name, sport_id: sport_id, sport_name: sport_name, team_id: team_id, team_name: team_name, user_id: user_id, user_name: user_name))
                print("Query Result:")
               // print("\(id) | \(name) | \(year)")
            }
        } else {
